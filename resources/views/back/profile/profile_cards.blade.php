    ...
    <section id="simple-user-cards" class="row">
      ...
      <div class="col-xl-3 col-md-6 col-12">
        <div class="card">
          <div class="text-center">
            <div class="card-body">
              <img src="../../../app-assets/images/portrait/medium/avatar-m-4.png" class="rounded-circle  height-150"
              alt="Card image">
            </div>
            <div class="card-body">
      ...
      <div class="col-xl-3 col-md-6 col-12">
        <div class="card">
          <div class="text-center">
            <div class="card-body">
              <img src="../../../app-assets/images/portrait/medium/avatar-m-1.png" class="rounded-circle  height-150"
              alt="Card image">
            </div>
            <div class="card-body">
      ...
      <div class="col-xl-3 col-md-6 col-12">
        <div class="card">
          <div class="text-center">
            <div class="card-body">
              <img src="../../../app-assets/images/portrait/medium/avatar-m-6.png" class="rounded-circle  height-150"
              alt="Card image">
            </div>
            <div class="card-body">
      ...
      <div class="col-xl-3 col-md-6 col-12">
        <div class="card">
          <div class="text-center">
            <div class="card-body">
              <img src="../../../app-assets/images/portrait/medium/avatar-m-5.png" class="rounded-circle  height-150"
              alt="Card image">
            </div>
            <div class="card-body">
    ...
    <section id="user-profile-cards-with-stats" class="row mt-2">
      ...
      <div class="col-xl-4 col-md-6 col-12">
        <div class="card profile-card-with-stats">
          <div class="text-center">
            <div class="card-body">
              <img src="../../../app-assets/images/portrait/medium/avatar-m-8.png" class="rounded-circle  height-150"
              alt="Card image">
            </div>
            <div class="card-body">
      ...
      <div class="col-xl-4 col-md-6 col-12">
        <div class="card profile-card-with-stats border-teal border-lighten-2">
          <div class="text-center">
            <div class="card-body">
              <img src="../../../app-assets/images/portrait/medium/avatar-m-7.png" class="rounded-circle  height-150"
              alt="Card image">
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
              <p>Lorem ipsum dolor sit amet, autem imperdiet et nam. Nullam labores
                id quo, sed ei.</p>
              <button type="button" class="btn btn-outline-danger btn-md btn-round mr-1"><i class="la la-plus"></i> Follow</button>
      ...
      <div class="col-xl-4 col-md-6 col-12">
        <div class="card profile-card-with-stats box-shadow-2">
          <div class="text-center">
            <div class="card-body">
              <img src="../../../app-assets/images/portrait/medium/avatar-m-10.png" class="rounded-circle  height-150"
              alt="Card image">
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
              <p>Lorem ipsum dolor sit amet, autem imperdiet et nam. Nullam labores
                id quo, sed ei.</p>
              <button type="button" class="btn btn-outline-danger btn-md btn-square mr-1"><i class="la la-plus"></i> Follow</button>
    ...
    <section id="user-profile-cards-with-cover-image" class="row mt-2">
      ...
      <div class="col-xl-4 col-md-6 col-12">
        <div class="card profile-card-with-cover">
          ...
          <div class="card-img-top img-fluid bg-cover height-200" style="background: url('../../../app-assets/images/carousel/18.jpg');"></div>
          <div class="card-profile-image">
            <img src="../../../app-assets/images/portrait/small/avatar-s-4.png" class="rounded-circle img-border box-shadow-1"
            alt="Card image">
          </div>
          <div class="profile-card-with-cover-content text-center">
            ...
            <div class="text-center">
              ...
              <a href="#" class="btn btn-social-icon mb-1 btn-outline-github">
      ...
      <div class="col-xl-4 col-md-6 col-12">
        <div class="card profile-card-with-cover border-teal border-lighten-2">
          ...
          <div class="card-img-top img-fluid bg-cover height-200" style="background: url('../../../app-assets/images/carousel/16.jpg');"></div>
          <div class="card-profile-image">
            <img src="../../../app-assets/images/portrait/small/avatar-s-9.png" class="rounded-circle img-border"
            alt="Card image">
          </div>
          <div class="profile-card-with-cover-content text-center">
            <div class="card-body">
      ...
      <div class="col-xl-4 col-md-6 col-12">
        <div class="card profile-card-with-cover box-shadow-2">
          ...
          <div class="card-profile-image">
            <img src="../../../app-assets/images/portrait/small/avatar-s-8.png" class="rounded-circle img-border box-shadow-4"
            alt="Card image">
          </div>
          <div class="profile-card-with-cover-content text-center">
            <div class="card-body">
