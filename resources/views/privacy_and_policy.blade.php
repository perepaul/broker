        ...
        <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="about-content">
                ...
                <p>saxotradinngmarket LTD, is a company registered in St. Vincent and the Grenadines and having its registered address at Hinds Building, Kingstown, St. Vincent and the Grenadines (hereinafter saxotradinngmarket). saxotradinngmarket is the controller and responsible for the data of its Client disclosed to it in order to register for a Trading Account, Demo Account and/or to make use of any other services offered by the saxotradinngmarket Group (as defined in Appendix A) through the website (hereinafter “Website”) (this term shall at all times include Website’s desktop and mobile versions). saxotradinngmarket exercises control over the processing of data in undertakings affiliated to it and which belong to the saxotradinngmarket Group of companies.</p>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="about-content">
                <h2 class="f-40 fw-400"> DATA USAGE</h2>
                <p>We may collect, use, store and transfer different kinds of data about you which we have grouped together as follows:</p>
                <p><span class="text-danger ml-5">1.</span> Identity Data includes first name, last name, and patronymic (if available), date of birth gender, passport, ID, Driver’s number, and copy of photo. </p>
                <p><span class="text-danger ml-5">2.</span> Contact Data includes billing address, email address and telephone numbers. </p>
                <p><span class="text-danger ml-5">3.</span> Financial Data includes bank account and payment card details. </p>
                <p><span class="text-danger ml-5">4.</span> Transaction Data includes details about the transactions performed by you, details about payments, withdrawals, exchanges, trading history, profit, balance, deposited and withdrawal amount methods, and any other details in relation to the services you have made use of through our Website. </p>
                <p><span class="text-danger ml-5">5.</span> Technical Data includes internet protocol (IP) address, your login data, browser type and version, time zone setting and location, browser plug-in type and versions, operating system and platform, and other technologies on the devices you use to access the Website and use of cookies stored on your device. </p>
                <p><span class="text-danger ml-5">6.</span> Profile Data includes your Client’s account details, username and password, transactions made by you, your interests, preferences, feedback and/or information received through your interaction with us within the course of providing our services and survey responses. </p>
                <p><span class="text-danger ml-5">7.</span> Usage Data includes information about how you use the Website, products and services, registration date, account category, trading cluster, number of complaints, number of requests filed and IP history. </p>
                <p><span class="text-danger ml-5">8.</span> Marketing and Communication Data includes your preferences in receiving marketing from us and your communication preferences. </p>
                <p><span class="text-danger ml-5">9.</span> Banking Data includes details of number of payment wallets and/or information of your bank card, including information of the issuing bank, card number, cardholder name, card expiration date, payment system, card validation code (CVV2 / CVC2), and photos of both sides of the bank card.</p>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="about-content">
             <h2 class="f-40 fw-400">HOW IS YOU PERSONAL DATA COLLECTED?</h2>
             <p>We use different methods to collect data from and about you including through:</p>
             <p>Direct Interactions. You will provide to us your Identity, Contact and Financial Data online through the Website and/or by filling in online forms and/or by corresponding with us by emails or otherwise. Data may be submitted to us by you when you wish to:</p>

             <p><span class="text-danger ml-5">1.</span> Register for a Trading Account; </p>
             <p><span class="text-danger ml-5">1.</span> Subscribe to our plan and ongoing updates; </p>
             <p><span class="text-danger ml-5">1.</span> Request marketing and promotions to be sent to you; </p>
             <p><span class="text-danger ml-5">1.</span> Give us feedback or contact us. </p>

             <p>We require to collect the above data in order that we are able to (i) provide our services efficiently,(ii) to comply with our ongoing legal and regulatory obligations, including, inter alia, (a) to prevent fraud and money laundering acts and/ or (b) conduct the assessment of suitability and appropriateness test</p>

             <p>If you fail to provide the data when requested we may not be able to perform the contract we have or trying to enter into with you (for example, to provide you with our services). In this case, we may have to cancel a service you have with us but we will notify you if this is the case at the time. It is important that the data we hold about you is accurate and current. Please keep us informed if your data changes during your relationship with us.</p>
