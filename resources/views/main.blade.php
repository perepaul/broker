    ...
    <div class="row">
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          <div class="about-content">
             ...
             <p>Sometimes investing can be complicated and confusing. Piptradesway breaks down the complexities of investing with intuitive tools that add efficiency and simplicity.
            </p>
             <p> A team of professionals speaking your mother tongue are always here to support you</p>
             <p>Piptradesway is a multi-functional platform which allows each participant to keep money in a multi-currency online wallet, buy and sell currency on the exchange, invest money, get a loan in a convenient currency.</p>
             {{-- <div class="buttons">
             ...
             <ul>
                <li>
                   ...
                   <div class="col-sm-6 pd-0">
                      <div class="imgs-l">
                         <figure><img src="/assets/front/images/features/1.png" alt=""/></figure>
                      </div>
                   </div>
                ...
                <li class="rl">
                   ...
                   <div class="col-sm-6 pd-0">
                      <div class="imgs-r">
                         <figure><img src="/assets/front/images/features/2.png" alt=""/></figure>
                      </div>
                   </div>
                ...
                <li>
                   ...
                   <div class="col-sm-6 pd-0">
                      <div class="imgs-l">
                         <figure><img src="/assets/front/images/features/3.png" alt=""/></figure>
                      </div>
                   </div>
                   <div class="col-sm-6 pd-0 visible-xs">
                      <div class="contents-l mr-b30">
                ...
                <li class="rl">
                   ...
                   <div class="col-sm-6 pd-0">
                      <div class="imgs-r">
                         <figure><img src="/assets/front/images/features/4.png" alt=""/></figure>
                      </div>
                   </div>
                   <div class="col-sm-6 pd-0 floatright mr-b30 visible-xs">
                      <div class="contents-r">
    ...
    <div class="row">
       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="project-list">
             <div class="content">
                <span class="icons"><img src="/assets/front/images/icons/6.png" alt=""/></span>
       ...
       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="project-list">
             <div class="content">
                <span class="icons"><img src="/assets/front/images/icons/7.png" alt=""/></span>
       ...
       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="project-list">
             <div class="content">
                <span class="icons"><img src="/assets/front/images/icons/8.png" alt=""/></span>
       ...
       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="project-list">
             <div class="content">
                <span class="icons"><img src="/assets/front/images/icons/9.png" alt=""/></span>
       ...
       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="project-list">
             <div class="content">
                <span class="icons"><img src="/assets/front/images/icons/10.png" alt=""/></span>
       ...
       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="project-list">
             <div class="content">
                <span class="icons"><img src="/assets/front/images/icons/11.png" alt=""/></span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="blog wow  fadeInUp animated" data-wow-duration="1.8s" style="visibility: visible; animation-duration: 1.8s; animation-name: fadeInUp;">
                        ...
                        <div class="content">
                            ...
                            <p>I invested with Piptradesway and i got my profit.</p>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="blog wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                       ...
                       <div class="content">
                           ...
                           <p>Piptradesway has made Forex trading simple and straight foward.</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="blog">
                       ...
                       <div class="content">
                           ...
                           <p>You won't regret trading with piptradesway, trust me you will love it.</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
