    ...
    <div class="row">
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          <div class="about-content">
             ...
             <p>Sometimes investing can be complicated and confusing. Piptradeway breaks down the complexities of investing with intuitive tools that add efficiency and simplicity.
            </p>
             <p> A team of professionals speaking your mother tongue are always here to support you</p>
             <p>Piptradeway is a multi-functional platform which allows each participant to keep money in a multi-currency online wallet, buy and sell currency on the exchange, invest money, get a loan in a convenient currency.</p>
             {{-- <div class="buttons">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="blog wow  fadeInUp animated" data-wow-duration="1.8s" style="visibility: visible; animation-duration: 1.8s; animation-name: fadeInUp;">
                        ...
                        <div class="content">
                            ...
                            <p>I invested with Piptradeway and i got my profit.</p>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="blog wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                       ...
                       <div class="content">
                           ...
                           <p>Piptradeway has made Forex trading simple and straight foward.</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="blog">
                       ...
                       <div class="content">
                           ...
                           <p>You won't regret trading with piptradeway, trust me you will love it.</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
